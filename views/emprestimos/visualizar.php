            ...
            ?>
              <div class="card custom-card" style="background-color: #2c2c2c; text-white">
                 <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">Emprestado para <a href="#"><?php echo $linha["NOME"]; ?> <?php echo $linha["SOBRENOME"]; ?></a></h6>
                    ...
                    <?php
                       ...
                       if ($linha["STATUS_LIVRO"] == "DEVOLVIDO") {
                        ...
                        else
                        {
                            ...
                            $tipo_botao = "info";
                            $link_botao = "/.../DB/emprestimos/MarcarDevolvido.php";
                        }
